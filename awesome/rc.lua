...
local themes = {
	nord = gears.filesystem.get_themes_dir() .. "awesome-nord-theme/theme.lua",
...
globalkeys = gears.table.join(
	...
	awful.key(
		...
		function()
			...
			naughty.destroy_all_notifications()
			  	 ...
			  	 timeout = 1,
                           	title = "Tag: " .. awful.screen.focused().selected_tag.index,
			   	text = awful.screen.focused().selected_tag.layout.name})
		end,
	...
	awful.key(
		...
		{description = "Show time", group = "jon" }),
	awful.key(
		{modkey}, "Right", 
		function()
	                awful.tag.viewnext()
...
--#	BOOT	#
--###############
awful.spawn.with_shell("sh /usr/share/jonfelix/boot.sh")
